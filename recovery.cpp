...
Device::BuiltinAction start_recovery(Device* device, const std::vector<std::string>& args) {
  ...
  // LMODROID_VERSION_APPEND_TIME_OF_DAY is set to true has the desired date.
  std::string ver = android::base::GetProperty("ro.lmodroid.version", "");
  ...
  std::vector<std::string> title_lines = {
    "Version " + android::base::GetProperty("ro.lmodroid.build_date", "(unknown)") +
        " (" + ver_date + ")",
  };
